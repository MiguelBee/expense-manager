...
class Pager extends React.Component {
	...
	calculate(state, pageNo) {
		...
		let hadPreviousPage = currentPage == 1 ? false : true;
					...
					<div className="container">
						<div className="pagination p1">
							<ul>
								...
								{pages}
								{this.state.currentPage != this.state.totalPages ? <a href="#" onClick={this.handleClick.bind(this, this.state.currentPage + 1)}><li>&gt;</li></a> : <span>&nbsp;</span>}
							</ul>
						</div>
					</div>
				</div>
